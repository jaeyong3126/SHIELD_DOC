...
#### 문서 파싱 및 개인정보 탐지 모듈
- TXT, PDF, DOCX 문서의 텍스트 추출 및 공통 형식 변환
- Regex 기반 주민등록번호, 전화번호, 이메일, 계좌번호 등 정형 개인정보 탐지
- API Key, Password, Access Token 등 Secret 정보 탐지
- NER 모델을 활용한 자연어 문장 내 비정형 개인정보 탐지 보완
- 탐지된 개인정보 및 Secret을 마스킹하고 안전한 텍스트만 후속 분석 단계로 전달
